...
class Mastermind(game):
    ...
    def autoPlay(self, toFind):
        print('|||>>||||>>>>>>>>>>>>>>>>>> PLAYING: ', self.currentGuess, ' Turn : ', self.turn)
        result =  self.checkPlay(self.currentGuess, toFind)
...
def GenerateRandomCode(mastmindGame):
